...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkQuery = "SELECT * FROM users WHERE regid = '$regid'";
    $result = $conn->query($checkQuery);

    if ($result->num_rows > 0) {
        echo "<p style='color:red;'>User already exists. Please try a different Register ID.</p>";
    } else {
       
        $insertQuery = "INSERT INTO users (regid, password) VALUES ('$regid', '$pwd')";
